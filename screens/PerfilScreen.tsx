import {Button,StyleSheet,Text,View,Image,TouchableOpacity,Alert,
} from "react-native";
...
import { update, onValue, ref as ref1 } from "firebase/database";
...
const [url, seturl] = useState("")
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: usuario.url }} style={styles.img} />
